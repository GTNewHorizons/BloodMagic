...
public class BloodMagicWailaPlugin {
    ...
    public static void callbackRegister(IWailaRegistrar register) {
        ...
        register.addConfig("AWWayofTime", WAILA_CONFIG_ALTAR, true);

        register.registerBodyProvider(wailaProvider, TETeleposer.class);
        register.addConfig("AWWayofTime", WAILA_CONFIG_TELEPOSER, true);
        ...
        register.addConfig("AWWayofTime", WAILA_CONFIG_RITUAL, true);
        ...
        register.addConfig("AWWayofTime", WAILA_CHEMISTRY_SET, true);
