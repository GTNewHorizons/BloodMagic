...
public class EntityFallenAngel extends EntityDemon implements IRangedAttackMob {
    ...
    public EntityFallenAngel(World world) {
        super(world, AlchemicalWizardry.entityFallenAngelID);
    ...
    public void attackEntityWithRangedAttack(EntityLivingBase entityLivingBase, float par2) {
        this.worldObj.spawnEntityInWorld(new HolyProjectile(worldObj, this, entityLivingBase, 1.8f, 0f, 5, 600));
    }
