...
public class EntitySmallEarthGolem extends EntityDemon implements IRangedAttackMob {
    ...
    private final EntityAIArrowAttack aiArrowAttack = new EntityAIArrowAttack(this, 1.0D, 25, 25, 15.0F);
    ...
    private static final float maxTamedHealth = 20.0F;
    private static final float maxUntamedHealth = 10.0F;

    public EntitySmallEarthGolem(World world) {
        super(world, AlchemicalWizardry.entitySmallEarthGolemID);
    ...
    public void attackEntityWithRangedAttack(EntityLivingBase entityLivingBase, float par2) {
        MudProjectile hol = new MudProjectile(worldObj, this, entityLivingBase, 1.8f, 0f, 3, 600, false);
