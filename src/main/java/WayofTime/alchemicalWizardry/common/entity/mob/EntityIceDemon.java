...
public class EntityIceDemon extends EntityDemon implements IRangedAttackMob {
    ...
    private final EntityAIArrowAttack aiArrowAttack = new EntityAIArrowAttack(this, 1.0D, 30, 50, 15.0F);
    ...
    public void attackEntityWithRangedAttack(EntityLivingBase entityLivingBase, float par2) {
        IceProjectile hol = new IceProjectile(worldObj, this, entityLivingBase, 1.8f, 0f, 3, 600);
