...
public class RenderReagentConduit extends TileEntitySpecialRenderer {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation(
            "alchemicalwizardry",
            "textures/models/SimpleTransCircle.png");

    @Override
    public void renderTileEntityAt(TileEntity tileEntity, double d0, double d1, double d2, float f) {
        if (!(tileEntity instanceof TEReagentConduit conduit)) {
            return;
        }
        int renderCount = conduit.renderCount;
        ...
        Int3 colourMap = conduit.getColour();
        GL11.glPushMatrix();
