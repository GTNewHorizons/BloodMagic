...
public class ClientUtils {
    ...
    public static void renderPlayerArmourInPOV(EntityPlayer player, float partialTickTime) {
        ...
        float f1 = 1.0f; // this.prevEquippedProgress + (this.equippedProgress - this.prevEquippedProgress) *
        // partialTickTime;
            ...
            if (entityclientplayermp.getItemInUseCount() > 0) {
                ...
                if (enumaction1 == EnumAction.block) {
                    ...
                    f10 = (float) itemstack.getMaxItemUseDuration()
                            - ((float) entityclientplayermp.getItemInUseCount() - partialTickTime + 1.0F);
                    f11 = f10 / 20.0F;
