 ...
 * <a href="https://github.com/bspkrs/bspkrsCore/blob/master/src/main/java/bspkrs/client/util/HUDUtils.java">Source</a>
 */
    ...
    public static void renderItemOverlayIntoGUI(FontRenderer fontRenderer, ItemStack itemStack, int x, int y,
        ...
        if (itemStack != null && (showDamageBar || showCount)) {
            ...
            if (showCount) {
                ...
                else if (itemStack.getItem() != null && itemStack.getItem().equals(Items.bow))
